            ...
            <div class="row">
                ...
                <div class=" col-12 col-md-8 ">
                    ...
                    <p class="leyenda-pasos">Elegí tu método de pago</p>
                        ...
                        <div class="form-check mt-2 d-none" id="opcion_efectivo">
                    ...
                    <div class="col-12 col-md-4 ">
                        <div class="card card-resumen-compra p-3"  >
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        function actualizarOpcionEfectivo() {
            if (radioEnvioRetiro.checked) {
                opcionEfectivo.classList.remove('d-none');
            } else {
                opcionEfectivo.classList.add('d-none');
                // Por seguridad, deselecciona efectivo si no es retiro
        ...
        // Inicializa según lo seleccionado al cargar
        actualizarOpcionEfectivo();
    });
</script>
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        actualizarResumen(); // Para el caso inicial
    });
</script>
