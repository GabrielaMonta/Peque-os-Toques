                    ...
                    <div class="col-12 col-md-6 text-md-end">
                        <div class="d-flex flex-column align-items-md-end">
                            <p class="mb-1"><strong>Estado:</strong>
                                <span class="badge border border-secondary text-dark"><?= esc($cabecera['estado_venta']) ?></span>
                            </p>
                            
                            <form action="<?= base_url('admin/actualizar-estado-venta') ?>" method="post" class="mt-2">
                                <?= csrf_field() ?>
                                <input type="hidden" name="venta_id" value="<?= esc($cabecera['id']) ?>">
