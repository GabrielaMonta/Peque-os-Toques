<div class="container mt-4">
    ...
    <div class=" mb-1 p-3">
        <form action="<?= base_url('ventas') ?>" method="get" class="row g-3 align-items-end">
            ...
            <div class="col-md-2 col-sm-3 "> <button type="submit" class="btn btn-primary">Aplicar Filtro</button>
                <a href="<?= base_url('ventas') ?>" class="btn btn-secondary ">Limpiar Filtro</a>
            </div>
        </form>
    </div>
